                ...
                <td className="border-b border-[var(--line)] px-2.5 py-2 text-sm">
                  <span
                    className={`inline-flex rounded-full px-2 py-1 text-xs font-semibold ${
                      request.status === "Pending" ? "bg-yellow-100 text-yellow-700" : request.status === "Approved" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"
                    }`}
                  >
                    {request.status}
                  </span>
                ...
                <td className="border-b border-[var(--line)] px-2.5 py-2 text-sm">
                  {request.status === "Pending" ? (
                    <div className="flex flex-wrap items-center gap-2">
                      <button className="rounded-md bg-green-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-green-700" onClick={() => updateRequestStatus(request.id, "Approved")} type="button">
                        Accept
                      </button>
                      <button className="rounded-md border border-red-200 bg-white px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-50" onClick={() => updateRequestStatus(request.id, "Rejected")} type="button">
                        Reject
                      </button>
                    </div>
                  ) : (
