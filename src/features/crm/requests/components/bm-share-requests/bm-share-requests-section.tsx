                ...
                <td className="border-b border-[var(--line)] px-2.5 py-2 text-sm">
                  {request.status === "Pending" ? (
                    <div className="flex flex-wrap items-center gap-2">
                      <button className="rounded-md border border-green-100 bg-white px-3 py-1.5 text-xs font-semibold text-green-600 hover:bg-green-50" onClick={() => updateRequestStatus(request.id, "Approved")} type="button">
                        Approve
                      </button>
                      <button className="rounded-md border border-red-100 bg-white px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-50" onClick={() => updateRequestStatus(request.id, "Rejected")} type="button">
                        Reject
                      </button>
                    </div>
                  ) : (
