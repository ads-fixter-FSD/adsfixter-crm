                ...
                {pendingClients.map((client) => (
                  <tr key={client.id}>
                    ...
                    <td className="border-b border-[var(--line)] px-3 py-2 text-sm">
                      <span className="inline-flex rounded-full bg-[var(--warning-bg)] px-2 py-1 text-xs font-semibold text-[var(--warning-text)]">Pending</span>
                    </td>
                    <td className="border-b border-[var(--line)] px-3 py-2 text-center text-sm">
                      <div className="flex flex-wrap items-center justify-center gap-2">
                        <button className="inline-flex min-h-8 items-center gap-1.5 rounded-lg border border-[var(--brand-orange)] bg-[var(--brand-orange)] px-2.5 text-xs font-semibold text-[var(--brand-orange-contrast)] transition hover:bg-[var(--brand-orange-hover)]" onClick={() => approveClient(client)} type="button">
                          <Check aria-hidden="true" size={13} strokeWidth={2.1} />
                          Approve
                        </button>
                        <button className="inline-flex min-h-8 items-center gap-1.5 rounded-lg border border-[var(--brand-orange)] bg-[var(--white)] px-2.5 text-xs font-semibold text-[var(--brand-orange)] transition hover:bg-[var(--brand-orange-soft)]" onClick={() => rejectClient(client)} type="button">
