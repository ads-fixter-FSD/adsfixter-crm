                ...
                <tr key={request.id}>
                  ...
                  <td className="border-b border-[var(--line)] px-3 py-2 text-sm">
                    <div className="flex flex-wrap items-center gap-2">
                      <button className="rounded-md border border-green-100 bg-green-50 px-3 py-1.5 text-xs font-semibold text-green-600 hover:bg-green-100" onClick={() => updateRequest(request.id, "approved")} type="button">
                        Approve
                      </button>
                      <button className="rounded-md border border-red-100 bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-100" onClick={() => updateRequest(request.id, "rejected")} type="button">
                        Reject
                      </button>
                    </div>
                  </td>
